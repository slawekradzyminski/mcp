Familiarise yourself with the project, read example code, tests, @README.md. and @REGRESSION_TESTS.md. Read also each of cursor rules defined in .cursor/rules folder.
